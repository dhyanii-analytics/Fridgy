...
🦴 The Skeleton: I used Python and Flask for the backend logic and a SQLite database to keep everything organized.

🎨 The Face: A clean, modern interface built using HTML, CSS, and JavaScript.

📊 The Data: I used Chart.js to build a cool dashboard for Admins to see how many people are cooking each week.

## 🚀 How to Get it Running
Clone it: Download the code from my GitHub repository.

Environment: Setup a Python virtual environment (venv) and install the requirements.

API Key: Grab your Groq API key and put it in a .env file.

Launch: Run python run.py and you're ready to start cooking!

## 🔮 What's Next? (Future Scope)
🗣️ Voice Control: I want to add a feature where you can say "Hey Fridgy, what's the next step?" so you don't have to touch your phone while cooking.
...
Developed  by Dhyanii Patel
Final Year Project (2025-2026)- M.Sc. (CA & IT), Indus University
